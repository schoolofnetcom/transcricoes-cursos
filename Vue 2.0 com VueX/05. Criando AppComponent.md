...
Acima temos a estrutura de um componente. Cada componente terá um template e todas as seus próprios dados e métodos. Conforme código abaixo:
...
Reparem que estamos utilizando o mesmo código que existia anteriormente, só adicionamos o **template** e o modelo de dados **data** passa a ser um método que retorna um objeto com todos os modelos de dados existentes. Temos os mesmos métodos e filtros anteriores, porém eles fazem parte do componente agora.
...
Colocamos todo html, que estava presente no arquivo **index.html**, na propriedade template do componente. Reparem que utilizamos aspas, para inserir o html, para que seja renderizado um bloco de html com multiplas linhas.

O componente está criado, agora só falta incluirmos ele em nossa instância do Vue e depois chamar a tag html na view. Vejo como fica o código para a instância Vue:
