...
O primeiro é responsável por criar a imagem de seu ambiente e o segundo é capaz mapear todos os serviços do docker, fazer todo compartilhamento de volumes que for necessário e também criar conexão entre os containers pra você.
