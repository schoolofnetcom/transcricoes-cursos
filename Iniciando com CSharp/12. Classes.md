...
Podemos utilizar o construtor de uma classe para iniciar os objetos instanciados com valores préestabelecidos. Isso não significa que o usuário não possa modificar depois, significa, apenas, que as propriedades terão valores iniciais. Vejam o exemplo:
